...
public class ThongKe extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        pChiTietTimKiem.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Doanh Thu", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 18), new java.awt.Color(255, 153, 0))); // NOI18N
        ...
        pChiTietLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pChiTietLayout.createSequentialGroup()
                ...
                .addGroup(pChiTietLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pChiTietTimKiem, javax.swing.GroupLayout.DEFAULT_SIZE, 535, Short.MAX_VALUE))
                .addGap(28, 28, 28))
        );
        ...
        pCenterLayout.setVerticalGroup(
            ...
            .addGroup(pCenterLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(pChiTiet, javax.swing.GroupLayout.PREFERRED_SIZE, 596, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void thongke(String date1, String date2) {
        ...
        if (ok.kiemTraDate(date1, date2)) {
            ...
            String loinhuan = "" + ln;
            jLabel3.setText(numberFormat.format(Double.parseDouble(decimalFormat.format(Double.parseDouble(tien2)))));
            jLabel9.setText(tien3);
            jLabel10.setText(numberFormat.format(Double.parseDouble(decimalFormat.format(Double.parseDouble(loinhuan)))));
            jLabel13.setText(String.valueOf(numberFormat.format(Double.parseDouble(decimalFormat.format(maxtien)))));
    ...
    private void actionButtondisplayPhieuNhap() {
        ...
        for (int i = 0; i < list_TK.getNumb(); i++) {
            ...
            row.add(decimalFormat.format(pn.getTongTien()));
